    ...
    <header class="edica-header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="index.html"><img src="{{ asset('assets/images/logo.svg') }}" alt="NeyroBlog"></a>
                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto  mt-2 mt-lg-0">
                        ...
                        <li class="nav-item" style="display:inline-block"><a class="nav-link" href="{{ route('messages.index') }}">Messages</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <div class="container">
            <div class="row footer-widget-area">
                <div class="col-md-3">
                    ...
                    <p class="contact-details">danil.philippov74@gmail.com</p>
                    <p class="contact-details">+79822988807</p>
